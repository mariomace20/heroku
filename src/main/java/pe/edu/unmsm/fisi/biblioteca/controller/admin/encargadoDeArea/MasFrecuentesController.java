...
public class MasFrecuentesController {
	
	public static final String INICIO_VIEW = "content/admin/encargadoDeArea/masFrecuentes";
		

	@GetMapping("/ebiblioteca/masFrecuentes")
	...
	@GetMapping("/evideoteca/masFrecuentes")
	...
	@GetMapping("/eaula_grupal/masFrecuentes")
