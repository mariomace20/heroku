...
public class TurnosController {
	...
	public static final String INICIO_VIEW = "content/admin/encargadoDeArea/turnos";
		

	@GetMapping("/ebiblioteca/turnos")
	...
	@GetMapping("/eaula_grupal/turnos")
