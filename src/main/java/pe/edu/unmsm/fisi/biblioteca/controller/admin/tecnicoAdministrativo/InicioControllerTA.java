...
public class InicioControllerTA {
	
	public static final String INICIO_VIEW = "content/admin/tecnicoAdministrativo/inicio";
		

	@GetMapping("/tbiblioteca/inicio")
	...
	@GetMapping("/taula_grupal/inicio")
